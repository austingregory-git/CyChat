...
public class MapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i1 = new Intent(MapActivity.this, HomeActivity.class);
                startActivity(i1);
            }
        });
        ...
        contactsB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i2 = new Intent(MapActivity.this, ContactsActivity.class);
                startActivity(i2);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case R.id.settings:
                Intent i1 = new Intent(MapActivity.this, SettingsActivity.class);
                startActivity(i1);
                return(true);
            case R.id.options:
                Intent i2 = new Intent(MapActivity.this, OptionsActivity.class);
                startActivity(i2);
                return(true);
            case R.id.map:
            ...
            case R.id.exit:
                ...
                return(true);
            case R.id.log_out:
                Intent i4 = new Intent(MapActivity.this, LoginActivity.class);
                startActivity(i4);
                return(true);
        }
